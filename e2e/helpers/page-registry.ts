...
export const pages: RegisteredPage[] = [
  ...
  { name: 'calendar-list', path: '/calendar/list', needsPerson: true },
  { name: 'calendar-new', path: '/calendar/new', needsPerson: true },
  { name: 'calendar-removed', path: '/calendar/removed', needsPerson: true },
  { name: 'settings-people', path: '/settings/people', needsPerson: true },
  { name: 'settings-backups', path: '/settings/backups', needsPerson: true },
  { name: 'settings-content-check', path: '/settings/content-check', needsPerson: true },
