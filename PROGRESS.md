...
| P1-08 | Spike: FTS5 search with block ids | done | (pending) | (pending) | `internal/kb/search` (query builder, ranking, snippet/highlight) and `migrations/kb/0001_search.sql` added. All 6 unit tests green on Windows locally. D-10 recorded. |
