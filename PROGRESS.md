...
| P1-13 | People: picker, add name, cookie | done | (pending) | (pending) | `internal/people` (store, picker handlers, identity middleware), `internal/app.OriginCheck`, migrations/people. Also fixed a P1-04 gap: `expectNoSideScroll` was defined but never wired to a test — added `e2e/frame/no-side-scroll.spec.ts` covering the page registry. 6 Go unit tests, 4 Go integration tests, 7 people E2E tests, updated a11y/screens/no-side-scroll for the `who` page — all green locally. D-14 recorded. |
