...
| P1-11 | Spike: Word converter and fixture generator | done | (pending) | (pending) | `internal/kb/docx` (Convert, size/depth-limited zip+XML reading, title/heading extraction) and `e2e/fixtures/docx/gen` (sample.docx, googledocs.docx, big-20pages.docx, bad/*, all byte-reproducible). Unit tests green (title/headings, all 6 bad fixtures reject cleanly, zip-bomb memory bound). D-07 recorded. |
