...
| P1-05 | CI workflow and repository policy tests | done | 12f0ef7 | https://github.com/stas-comp/comphq/actions/runs/35113562822 | First CI run: `go` and `browser` jobs green; `container`/`speed`/`screens` correctly skipped (no flag/tag). `.github/workflows/ci.yml` added. Real `tools/policy` checks replace the P1-04 placeholder. D-03, D-04 recorded. |
